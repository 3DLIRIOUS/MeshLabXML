...
def join(script, merge_visible=True, merge_vert=False, delete_layer=True,
    ...
    filter_xml = ''.join([
        ...
        '    <Param value="{}" '.format(str(merge_visible).lower()),
        'name="MergeVisible" ',
        'description="Merge Only Visible Layers" ',
        'type="RichBool" ',
        '/>\n',
        '    <Param value="{}" '.format(str(merge_vert).lower()),
        'name="MergeVertices" ',
        'description="Merge duplicate vertices" ',
        'type="RichBool" ',
        '/>\n',
        '    <Param value="{}" '.format(str(delete_layer).lower()),
        'name="DeleteLayer" ',
        'description="Delete Layers" ',
        'type="RichBool" ',
        '/>\n',
        '    <Param value="{}" '.format(str(keep_unreferenced_vert).lower()),
...
def change(script, layer_num=None):
    ...
    if script.ml_version == '1.3.4BETA' or script.ml_version == '2016.12':
        filter_xml = ''.join([
            ...
            '    <Param value="{:d}" '.format(layer_num),
            'name="mesh" ',
            'description="Mesh" ',
            'type="RichMesh" ',
            '/>\n',
