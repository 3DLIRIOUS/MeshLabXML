...
def close_holes(script, hole_max_edge=30, selected=False,
    ...
    filter_xml = ''.join([
        ...
        'type="RichBool" ',
        '/>\n',
        '    <Param value="{}" '.format(str(sel_new_face).lower()),
        'name="NewFaceSelected" ',
        'description="Select the newly created faces" ',
        'type="RichBool" ',
        '/>\n',
        '    <Param value="{}" '.format(str(self_intersection).lower()),
...
def split_vert_on_nonmanifold_face(script, vert_displacement_ratio=0.0):
    ...
    filter_xml = ''.join([
        '  <filter name="{}">\n'.format(filter_name),
        '    <Param value="{}" '.format(vert_displacement_ratio),
        'name="VertDispRatio" ',
...
def snap_mismatched_borders(script, edge_dist_ratio=0.01, unify_vert=True):
    ...
    filter_xml = ''.join([
        ...
        '    <Param value="{}" '.format(edge_dist_ratio),
        'name="EdgeDistRatio" ',
        'description="Edge Distance Ratio" ',
        'type="RichFloat" ',
        '/>\n',
        '    <Param value="{}" '.format(str(unify_vert).lower()),
        'name="UnifyVertices" ',
