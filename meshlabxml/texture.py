...
def project_rasters(script='TEMP3D_default.mlx',
                    ...
                    dorefill=True, deptheta=0.5,
                    onselection=False, useangle=True, usedistance=True,
                    useborders=True, usesilhouettes=True, usealpha=False,
                    current_layer=None, last_layer=None):
    """Set texture
    ...
    script_file.write(' '.join([
        '    <Param',
        'name="usesilhouettes"',
        'value="%s"' % str(usesilhouettes).lower(),
